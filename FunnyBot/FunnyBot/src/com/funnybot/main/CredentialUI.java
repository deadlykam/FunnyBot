...
public class CredentialUI extends javax.swing.JFrame {
    ...
    /**
     * This method checks if the credentials given
     * are correct.
     * 
     * @return True means the credentials given are correct,
     *         false otherwise, of type boolean
     */
    private boolean ValidateInfo()
    {
        // Condition to check if the validation failed
        if(txtConsumerKey.getText().isEmpty() || 
           txtConsumerSecret.getText().isEmpty() ||
           txtAccessToken.getText().isEmpty() ||
           txtAccessTokenSecret.getText().isEmpty())
        {
            return false;
        }
    ...
    private void btnSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetActionPerformed
        // Checking if the credentials given follows
        // the standard
        if(ValidateInfo())
        {
